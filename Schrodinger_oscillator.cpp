...
// Schrodinger_oscillator.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CSchrodinger_oscillatorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CSchrodinger_oscillatorApp

CSchrodinger_oscillatorApp::CSchrodinger_oscillatorApp()
{
...
// Единственный объект CSchrodinger_oscillatorApp

CSchrodinger_oscillatorApp theApp;


// Инициализация CSchrodinger_oscillatorApp

BOOL CSchrodinger_oscillatorApp::InitInstance()
{
	...
	CSchrodinger_oscillatorDlg dlg;
	m_pMainWnd = &dlg;
...
BOOL CSchrodinger_oscillatorApp::ExitInstance()
{
	AfxOleTerm(FALSE);
